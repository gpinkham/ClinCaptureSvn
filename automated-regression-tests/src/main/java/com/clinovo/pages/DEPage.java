...
public class DEPage extends BasePage {
	public static final String PAGE_NAME = "DE page";
	...
	/**
	 * Method checks if data in the fields from CRF correspond with data from this CRF bean on DE page.
	 *
	 * @param crf
	 * 			CRF
	...
	public Map<String, Boolean> checkDataInCRF(CRF crf) {
		...
		for (String fieldName : names) {
			...
			case "C":
				...
				result.put(fieldName, setOfCheckedItems.equals(set));
				break;
			case "F":
				// upload file
