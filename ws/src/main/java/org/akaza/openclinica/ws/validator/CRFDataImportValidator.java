...
public class CRFDataImportValidator implements Validator {
	...
	public void validate(Object obj, Errors e) {
		...
		// if (study == null) {
		// e.reject("subjectTransferValidator.study_does_not_exist", new Object[] { crfDataImportBean.getStudyUniqueId()
		...
		// e.reject("subjectTransferValidator.study_status_wrong", new Object[] { crfDataImportBean.getStudyUniqueId()
		// }, "Study "
