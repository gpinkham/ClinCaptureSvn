...
public class EventEndpoint {
	...
	public Source createSubject(@XPathParam("//e:event") NodeList event, @XPathParam("//e:study") String study,
			@XPathParam("//e:eventDefinitionOID") String eventDefinitionOID,
			@XPathParam("//e:location") String location, @XPathParam("//e:startDate") String startDate,
			@XPathParam("//e:startTime") String startTime, @XPathParam("//e:endDate") String endDate,
	...
	private StudyEventTransferBean unMarshallToEventTransfer(Element eventElement) throws ParseException {
		...
		StudyEventTransferBean studyEventTransferBean = new StudyEventTransferBean(studySubjectId, studyIdentifier,
				siteIdentifier, eventDefinitionOID, location, getDate(startDate, startTime), getDate(endDate, endTime),
				getUserAccount());
