...
public class HtmlUtils {
	...
	/**
	 * Generates the necessary Javascript code to create a localized CalendarPopup object. It adjusts: First day of the
	 * week Day headers Month names Month abbreviations "Today" text
	 * 
	 * @param varname
	...
	/**
	 * This class parses a date String like "12/10/2007" into an int[] array such as {12, 10, 2007} for use, among
	 * others, in creating a GregorianClandar object. The method assumes a default database format of "12/10/2007" or
	 * "MM/dd/yyyy".
	 * 
	 * @param dateString
	 *            A String like "12/10/2007".
	 * @return An int array made up of month, day, year (three components, in that order). If the dateString argument is
	 *         invalid or empty, returns an empty array.
	...
	/**
	 * Parse a date String like "12/10/2007" into an array, then create a GregorianCalendar object, returning a Date
	 * object for formatting. This class assumes a format pattern of MM/dd/yyyy.
	 * 
	 * @param _date
	 *            A String like "12/10/2007" . If the argument cannot be parsed into three segments, then the method
	 *            returns null.
