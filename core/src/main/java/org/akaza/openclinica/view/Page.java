...
public class Page {
	...
	public final static Page LOGIN_USER_ACCOUNT_DELETED = new Page("/WEB-INF/jsp/login/login.jsp"
	 ...
	 */
	public final static Page RESET_PASSWORD = new Page("/WEB-INF/jsp/login/resetPassword.jsp",
	 ...
	 */
	public final static Page UPDATE_PROFILE_CONFIRM = new Page("/WEB-INF/jsp/login/updateProfileConfirm.jsp",
	...
	public final static Page REQUEST_STUDY_CONFIRM = new Page("/WEB-INF/jsp/login/requestStudyConfirm.jsp",
	...
	public final static Page CHANGE_STUDY_CONFIRM = new Page("/WEB-INF/jsp/login/changeStudyConfirm.jsp",
	...
	public final static Page REQUEST_ACCOUNT_CONFIRM = new Page("/WEB-INF/jsp/login/requestAccountConfirm.jsp",
			"Request account confirm");
	/**
	 * Page for user to confirm inputs of requesting password
	 */
	public final static Page REQUEST_PWD_CONFIRM = new Page("/WEB-INF/jsp/login/requestPasswordConfirm.jsp",
	...
	public final static Page EDIT_ACCOUNT_CONFIRM = new Page("/WEB-INF/jsp/admin/edituseraccountconfirm.jsp",
			"Edit an account");

	/**
	 * Page for viewing all user accounts (for admin)
	 */
	public final static Page LIST_USER_ACCOUNTS = new Page("/WEB-INF/jsp/admin/listuseraccounts.jsp",
			"List user accounts");
	...
	public final static Page CONFIGURATION_PASSWORD_REQUIREMENTS = new Page(
	 ...
	 */
	public final static Page CREATE_STUDY1 = new Page("/WEB-INF/jsp/managestudy/createStudy1.jsp",
			"Create a new Study first section");
	public final static Page CREATE_STUDY2 = new Page("/WEB-INF/jsp/managestudy/createStudy2.jsp",
			"Create a new Study second section");
	public final static Page CREATE_STUDY3 = new Page("/WEB-INF/jsp/managestudy/createStudy3.jsp",
			"Create a new Study third section");
	public final static Page CREATE_STUDY4 = new Page("/WEB-INF/jsp/managestudy/createStudy4.jsp",
			"Create a new Study forth section");
	public final static Page CREATE_STUDY5 = new Page("/WEB-INF/jsp/managestudy/createStudy5.jsp",
			"Create a new Study fifth section");
	public final static Page CREATE_STUDY6 = new Page("/WEB-INF/jsp/managestudy/createStudy6.jsp",
			"Create a new Study sixth section");
	public final static Page CREATE_STUDY7 = new Page("/WEB-INF/jsp/managestudy/createStudy7.jsp",
			"Create a new Study seventh section");
	public final static Page CREATE_STUDY8 = new Page("/WEB-INF/jsp/managestudy/createStudy8.jsp",
			"Create a new Study last section");

	/**
	 * Page for confirming a new study.
	 */
	public final static Page STUDY_CREATE_CONFIRM = new Page("/WEB-INF/jsp/managestudy/studyCreateConfirm.jsp",
			"Confirm a new Study");

	/**
	 * Page for update a study.
	 */
	public final static Page UPDATE_STUDY1 = new Page("/WEB-INF/jsp/managestudy/updateStudy1.jsp",
			"Update a Study first section");
	public final static Page UPDATE_STUDY2 = new Page("/WEB-INF/jsp/managestudy/updateStudy2.jsp",
			"Update a Study second section");
	public final static Page UPDATE_STUDY3 = new Page("/WEB-INF/jsp/managestudy/updateStudy3.jsp",
			"Update a Study third section");
	public final static Page UPDATE_STUDY4 = new Page("/WEB-INF/jsp/managestudy/updateStudy4.jsp",
			"Update a Study forth section");
	public final static Page UPDATE_STUDY5 = new Page("/WEB-INF/jsp/managestudy/updateStudy5.jsp",
			"Update a Study fifth section");
	public final static Page UPDATE_STUDY6 = new Page("/WEB-INF/jsp/managestudy/updateStudy6.jsp",
			"Update a Study sixth section");
	public final static Page UPDATE_STUDY7 = new Page("/WEB-INF/jsp/managestudy/updateStudy7.jsp",
			"Update a Study seventh section");
	public final static Page UPDATE_STUDY8 = new Page("/WEB-INF/jsp/managestudy/updateStudy8.jsp",
			"Update a Study last section");

	public final static Page LIST_STUDY_SUBJECTS = new Page("/WEB-INF/jsp/managestudy/findSubjects.jsp",
			"List Study Subjects");
	...
	public final static Page UPDATE_STUDY_NEW = new Page("/WEB-INF/jsp/managestudy/updateStudyNew.jsp",
			"Update a Study");
	 ...
	 */
	public final static Page STUDY_UPDATE_CONFIRM = new Page("/WEB-INF/jsp/managestudy/studyUpdateConfirm.jsp",
			"Confirm a Study");

	/**
	 * Page for creating a new sub study.
	 */
	public final static Page CREATE_SUB_STUDY = new Page("/WEB-INF/jsp/managestudy/createSubStudy.jsp",
			"Create a sub Study");

	/**
	 * Page for confirming a new sub study.
	 */
	public final static Page CONFIRM_CREATE_SUB_STUDY = new Page("/WEB-INF/jsp/managestudy/createSubStudyConfirm.jsp",
			"Confirm a new site");

	/**
	 * Page for confirming a new sub study.
	 */
	public final static Page CONFIRM_UPDATE_SUB_STUDY = new Page("/WEB-INF/jsp/managestudy/updateSubStudyConfirm.jsp",
			"Confirm a site");

	/**
	 * Page for updating a new sub study.
	 */
	public final static Page UPDATE_SUB_STUDY = new Page("/WEB-INF/jsp/managestudy/updateSubStudy.jsp",
			"Update a sub Study");
	 ...
	 */
	public final static Page EDIT_STUDY_USER_ROLE = new Page("/WEB-INF/jsp/admin/editstudyuserrole.jsp",
			"Edit Study User Role");

	/**
	 * Page for view all users of a study and its sites.
	 */
	public final static Page STUDY_USER_LIST = new Page("/WEB-INF/jsp/managestudy/studyUserList.jsp",
			"View Study Users");
	/**
	...
	public final static Page SIGN_STUDY_SUBJECT = new Page("/WEB-INF/jsp/managestudy/signStudySubject.jsp",
			"Sign Study Subject");

	/**
	 * Page for view all study group classes.
	 */
	public final static Page SUBJECT_GROUP_CLASS_LIST = new Page("/WEB-INF/jsp/managestudy/subjectGroupClassList.jsp",
			"View All Group Class");
	public final static Page SUBJECT_GROUP_CLASS_LIST_SERVLET = new Page("/ListSubjectGroupClass",
			"View Subject Group Class Servlet");
	public final static Page CREATE_SUBJECT_GROUP_CLASS = new Page(
			"/WEB-INF/jsp/managestudy/createSubjectGroupClass.jsp", "Create Subject Group Class");
	public final static Page CREATE_SUBJECT_GROUP_CLASS_CONFIRM = new Page(
			"/WEB-INF/jsp/managestudy/createSubjectGroupClassConfirm.jsp", "Create Subject Group Class Confirm");
	public final static Page UPDATE_SUBJECT_GROUP_CLASS = new Page(
			"/WEB-INF/jsp/managestudy/updateSubjectGroupClass.jsp", "Update Subject Group Class");
	public final static Page UPDATE_SUBJECT_GROUP_CLASS_CONFIRM = new Page(
			"/WEB-INF/jsp/managestudy/updateSubjectGroupClassConfirm.jsp", "Update Subject Group Class Confirm");
	public final static Page VIEW_SUBJECT_GROUP_CLASS = new Page("/WEB-INF/jsp/managestudy/viewSubjectGroupClass.jsp",
			"View Subject Group Class");
	public final static Page REMOVE_SUBJECT_GROUP_CLASS = new Page(
			"/WEB-INF/jsp/managestudy/removeSubjectGroupClass.jsp", "Remove Subject Group Class");
	public final static Page RESTORE_SUBJECT_GROUP_CLASS = new Page(
			"/WEB-INF/jsp/managestudy/restoreSubjectGroupClass.jsp", "Restore Subject Group Class");

	/**
	 * Page for defining a study event.
	 */
	public final static Page DEFINE_STUDY_EVENT1 = new Page("/WEB-INF/jsp/managestudy/defineStudyEvent1.jsp",
			"Define Study Event");
	public final static Page DEFINE_STUDY_EVENT2 = new Page("/WEB-INF/jsp/managestudy/defineStudyEvent2.jsp",
			"Define Study Event");
	public final static Page DEFINE_STUDY_EVENT3 = new Page("/WEB-INF/jsp/managestudy/defineStudyEvent3.jsp",
			"Define Study Event");
	public final static Page DEFINE_STUDY_EVENT_CONFIRM = new Page(
			"/WEB-INF/jsp/managestudy/defineStudyEventConfirm.jsp", "Define Study Event Confirm");

	/**
	 * Page for updating a study event definition.
	 */
	public final static Page UPDATE_EVENT_DEFINITION1 = new Page("/WEB-INF/jsp/managestudy/updateEventDefinition1.jsp",
			"Update Event Definition");
	public final static Page UPDATE_EVENT_DEFINITION2 = new Page("/WEB-INF/jsp/managestudy/updateEventDefinition2.jsp",
			"Update Event Definition");
	public final static Page UPDATE_EVENT_DEFINITION_CONFIRM = new Page(
			"/WEB-INF/jsp/managestudy/updateEventDefinitionConfirm.jsp", "Update Event Definition Confirm");

	/**
	 * Page for viewing definition
	 */
	public final static Page VIEW_EVENT_DEFINITION = new Page("/WEB-INF/jsp/managestudy/viewEventDefinition.jsp",
			"View Event Definition");
	public final static Page VIEW_EVENT_DEFINITION_READONLY = new Page(
			"/WEB-INF/jsp/managestudy/viewEventDefinitionReadOnly.jsp", "View Event Definition");
	public final static Page VIEW_EVENT_DEFINITION_SERVLET = new Page("/ViewEventDefinition",
			"View Event Definition Servlet");

	/**
	 * Page for removing definition
	 */
	public final static Page REMOVE_DEFINITION = new Page("/WEB-INF/jsp/managestudy/removeDefinition.jsp",
			"Remove Event Definition");
	/**
	 * Page for removing definition
	 */
	public final static Page RESTORE_DEFINITION = new Page("/WEB-INF/jsp/managestudy/restoreDefinition.jsp",
			"Restore Event Definition");

	/**
	 * Page for locking definition
	 */
	public final static Page LOCK_DEFINITION = new Page("/WEB-INF/jsp/managestudy/lockDefinition.jsp",
			"Lock Event Definition");
	/**
	 * Page for unlocking definition
	 */
	public final static Page UNLOCK_DEFINITION = new Page("/WEB-INF/jsp/managestudy/unlockDefinition.jsp",
	 ...
	 */
	public final static Page AUDIT_USER_ACTIVITY = new Page("/WEB-INF/jsp/admin/auditUserActivity.jsp",
			"Audit User Activity");
	...
	public final static Page UPDATE_CRF_CONFIRM = new Page("/WEB-INF/jsp/admin/updateCRFConfirm.jsp",
			"Update a CRF Confirm");

	/**
	 * Page for creating crf confirm.
	 */
	public final static Page CREATE_CRF_CONFIRM = new Page("/WEB-INF/jsp/admin/createCRFConfirm.jsp",
			"Create a new CRF Confirm");

	/**
	 * Page for creating crf version.
	 */
	public final static Page CREATE_CRF_VERSION = new Page("/WEB-INF/jsp/admin/createCRFVersion.jsp",
			"Create a new CRF Version");
	public final static Page UPLOAD_CRF_VERSION = new Page("/WEB-INF/jsp/admin/uploadCRFVersionFile.jsp",
			"Upload a new CRF Version");

	public final static Page REMOVE_CRF_VERSION = new Page("/WEB-INF/jsp/admin/removeCRFVersion.jsp",
			"Remove CRF Version");
	public final static Page RESTORE_CRF_VERSION = new Page("/WEB-INF/jsp/admin/restoreCRFVersion.jsp",
			"Restore CRF Version");
	...
	public final static Page VERIFY_IMPORT_SERVLET = new Page("/VerifyImportedCRFData",
			"Verify Imported CRF Data Servlet");
	public final static Page VERIFY_IMPORT_CRF_DATA = new Page("/WEB-INF/jsp/submit/verifyImport.jsp",
	...
	public final static Page VIEW_RULE_SETS2 = new Page("/WEB-INF/jsp/submit/listRuleSets2.jsp",
			"List Rule Assignments");
	public final static Page VIEW_RULE_SETS_DESIGNER = new Page("/WEB-INF/jsp/submit/listRuleSetsDesigner.jsp",
			"List Rule Assignments");
	public final static Page VERIFY_RULES_IMPORT_SERVLET = new Page("/VerifyImportedRule",
			"Verify Imported Rule Servlet");
	public final static Page VERIFY_RULES_IMPORT = new Page("/WEB-INF/jsp/submit/verifyImportRule.jsp",
	...
	public final static Page VIEW_RULESET_AUDITS = new Page("/WEB-INF/jsp/submit/viewRuleSetAudits.jsp",
			"View Rule Audits");
	 ...
	 * Page for creating crf version.
	 */
	public final static Page CREATE_CRF_VERSION_SERVLET = new Page("/CreateCRFVersion",
			"Create a new CRF Version Servlet");
	/**
	 * Page for confirming crf version.
	 */
	public final static Page CREATE_CRF_VERSION_CONFIRM = new Page("/WEB-INF/jsp/admin/createCRFVersionConfirm.jsp",
			"Create a new CRF Version Confirm");
	public final static Page CREATE_CRF_VERSION_CONFIRMSQL = new Page(
			"/WEB-INF/jsp/admin/createCRFVersionConfirmSQL.jsp", "Create a new CRF Version Confirm SQL");
	public final static Page CREATE_CRF_VERSION_DONE = new Page("/WEB-INF/jsp/admin/createCRFVersionDone.jsp",
			"Create a new CRF Version Done");
	public final static Page REMOVE_CRF_VERSION_CONFIRM = new Page("/WEB-INF/jsp/admin/removeCRFVersionConfirm.jsp",
			"Remove CRF Version Confirm");
	public final static Page CREATE_CRF_VERSION_NODELETE = new Page("/WEB-INF/jsp/admin/createCRFVersionNoDelete.jsp",
			"Create a new CRF cannot delete version");
	public final static Page CREATE_CRF_VERSION_ERROR = new Page("/WEB-INF/jsp/admin/createCRFVersionError.jsp",
			"Create a new CRF error");
	public final static Page REMOVE_CRF_VERSION_DEF = new Page("/WEB-INF/jsp/admin/removeCRFVersionDef.jsp",
			"Remove CRF Version From Definition");

	public final static Page AUDIT_LOG_USER = new Page("/WEB-INF/jsp/admin/auditLogUser.jsp",
			"Audit Log display by User");
	public final static Page AUDIT_LOG_STUDY = new Page("/WEB-INF/jsp/admin/auditLogStudy.jsp",
	 ...
	 */
	public final static Page EXTRACT_DATASETS_MAIN = new Page("/WEB-INF/jsp/extract/extractDatasetsMain.jsp",
	...
	public final static Page VIEW_EMPTY_DATASETS = new Page("/WEB-INF/jsp/extract/viewEmptyDatasets.jsp",
			"View Datasets");
	public final static Page VIEW_DATASET_DETAILS = new Page("/WEB-INF/jsp/extract/viewDatasetDetails.jsp",
			"View Dataset Details");

	public final static Page EXPORT_DATASETS = new Page("/WEB-INF/jsp/extract/exportDatasets.jsp", "Export Dataset");
	public final static Page GENERATE_DATASET = new Page("/WEB-INF/jsp/extract/generatedDataset.jsp",
			"Generate Dataset");
	public final static Page GENERATE_DATASET_HTML = new Page("/WEB-INF/jsp/extract/generatedDatasetHtml.jsp",
			"Generate Dataset");
	public final static Page GENERATE_EXCEL_DATASET = new Page("/WEB-INF/jsp/extract/generatedExcelDataset.jsp",
			"Generate Excel Dataset");

	public final static Page CREATE_DATASET_1 = new Page("/WEB-INF/jsp/extract/createDatasetBegin.jsp",
			"Create Dataset Begin");
	public final static Page CREATE_DATASET_2 = new Page("/WEB-INF/jsp/extract/createDatasetStep2.jsp",
			"Create Dataset Step Two");
	public final static Page CREATE_DATASET_3 = new Page("/WEB-INF/jsp/extract/createDatasetStep3.jsp",
			"Create Dataset Step Three");
	public final static Page CREATE_DATASET_4 = new Page("/WEB-INF/jsp/extract/createDatasetStep4.jsp",
			"Create Dataset Step Four");
	public final static Page CONFIRM_DATASET = new Page("/WEB-INF/jsp/extract/createDatasetConfirmMetadata.jsp",
			"Create Dataset Step Four");

	public final static Page CREATE_DATASET_EVENT_ATTR = new Page("/WEB-INF/jsp/extract/selectEventAttribute.jsp",
			"Create Dataset and select event Attribute");
	public final static Page CREATE_DATASET_SUB_ATTR = new Page("/WEB-INF/jsp/extract/selectSubAttribute.jsp",
			"Create Dataset and select subject Attribute");
	public final static Page CREATE_DATASET_GROUP_ATTR = new Page("/WEB-INF/jsp/extract/selectGroupAttribute.jsp",
	...
	public final static Page CREATE_DATASET_APPLY_FILTER_SERVLET = new Page("CreateDatasetApplyFilter",
			"Create Dataset Apply Filter");
	public final static Page CREATE_DATASET_APPLY_FILTER = new Page(
			"/WEB-INF/jsp/extract/createDatasetApplyFilter.jsp", "Create Dataset Apply Filter");

	public final static Page CREATE_DATASET_VIEW_SELECTED = new Page("/WEB-INF/jsp/extract/viewSelected.jsp",
			"View Selected Items");
	public final static Page CREATE_DATASET_VIEW_SELECTED_HTML = new Page("/WEB-INF/jsp/extract/viewSelectedHtml.jsp",
	...
	public final static Page PAGE_TO_CREATE_NEW_STUDY_EVENT = new Page(path + "submit/pageToCreateNewStudyEvent.jsp",
			"Create a New Study Event");
	public final static Page CREATE_NEW_STUDY_EVENT = new Page(path + "submit/createNewStudyEvent.jsp",
			"Create a New Study Event");
	public final static Page CREATE_NEW_STUDY_EVENT_SERVLET = new Page("/CreateNewStudyEvent",
			"Create a New Study Event");

	public final static Page INSTRUCTIONS_ENROLL_SUBJECT = new Page(path + "submit/instructionsEnrollSubject.jsp",
	...
	public final static Page ADD_EXISTING_SUBJECT = new Page(path + "submit/addExistingSubject.jsp",
			"Enroll An Existing Subject");

	public final static Page INSTRUCTIONS_ENROLL_SUBJECT_SERVLET = new Page("/AddNewSubject?instr=1",
			"Enroll New Subject Servlet");

	public final static Page FIND_STUDY_EVENTS_SERVLET = new Page("/FindStudyEvents", "Find Study Events");
	public final static Page FIND_STUDY_EVENTS_STEP1 = new Page(path + "submit/findStudyEventsStep1.jsp",
			"Find Study Events - Step 1");
	public final static Page FIND_STUDY_EVENTS_STEP2 = new Page(path + "submit/findStudyEventsStep2.jsp",
			"Find Study Events - Step 2");
	public final static Page FIND_STUDY_EVENTS_STEP3 = new Page(path + "submit/findStudyEventsStep3.jsp",
			"Find Study Events - Step 3");

	public final static Page SHUFFLE_DNS_PAGE = new Page(path + "submit/shuffleDNsPage.jsp", "Shuffle DiscrepancyNotes");
	public final static Page CRF_LIST_FOR_STUDY_EVENT = new Page(path + "submit/crfListForStudyEvent.jsp",
			"Enter Data for a Study Event");
	public final static Page ENTER_DATA_FOR_STUDY_EVENT = new Page(path + "submit/enterDataForStudyEvent.jsp",
			"Enter Data for a Study Event");
	public final static Page ENTER_DATA_FOR_STUDY_EVENT_SERVLET = new Page("/EnterDataForStudyEvent",
			"Enter Data for a Study Event");

	public final static Page TABLE_OF_CONTENTS = new Page(path + "submit/tableOfContents.jsp",
	...
	public final static Page INTERVIEWER = new Page(path + "submit/interviewer.jsp",
			"Event CRF Interview Info Submission");
	public final static Page INTERVIEWER_ENTIRE_PAGE = new Page(path + "submit/interviewerEntirePage.jsp",
			"Event CRF Interview Info Submission");
	...
	public final static Page MARK_EVENT_CRF_COMPLETE = new Page(path + "submit/markEventCRFComplete.jsp",
	...
	public final static Page LIST_USER_IN_STUDY = new Page(path + "managestudy/listUserInStudy.jsp",
			"list users in a study");
	public final static Page VIEW_USER_IN_STUDY = new Page(path + "managestudy/viewUserInStudy.jsp",
	...
	public final static Page VIEW_STUDY_SUBJECT_AUDIT = new Page(path + "managestudy/viewStudySubjectAudit.jsp",
			"View Subject in a study Audit");
	public final static Page VIEW_STUDY_SUBJECT_SERVLET = new Page("/ViewStudySubject",
			"View Subject in a study Servlet");

	public final static Page UPDATE_STUDY_SUBJECT = new Page(path + "managestudy/updateStudySubject.jsp",
	...
	public final static Page UPDATE_STUDY_SUBJECT_CONFIRM = new Page(
			path + "managestudy/updateStudySubjectConfirm.jsp", "update Subject in a study Confirm");

	public final static Page REMOVE_STUDY_SUBJECT = new Page(path + "managestudy/removeStudySubject.jsp",
			"Remove Subject from a study");
	public final static Page RESTORE_STUDY_SUBJECT = new Page(path + "managestudy/restoreStudySubject.jsp",
			"Restore Subject to a study");

	public final static Page REMOVE_STUDY_EVENT = new Page(path + "managestudy/removeStudyEvent.jsp",
			"Remove Event from a study");
	public final static Page RESTORE_STUDY_EVENT = new Page(path + "managestudy/restoreStudyEvent.jsp",
	...
	public final static Page RESTORE_EVENT_CRF = new Page(path + "managestudy/restoreEventCRF.jsp",
	...
	public final static Page UPDATE_SUBJECT_CONFIRM = new Page(path + "admin/updateSubjectConfirm.jsp",
			"confirm update a subject");
	public final static Page REASSIGN_STUDY_SUBJECT = new Page(path + "managestudy/reassignStudySubject.jsp",
			"reassign a subject");
	public final static Page REASSIGN_STUDY_SUBJECT_CONFIRM = new Page(path
	...
	public final static Page SET_USER_ROLE = new Page(path + "admin/setUserRole.jsp",
	...
	public final static Page VIEW_TABLE_OF_CONTENT = new Page("/WEB-INF/jsp/managestudy/viewTableOfContents.jsp",
			"View Table Of Contents");
	public final static Page VIEW_TABLE_OF_CONTENT_SERVLET = new Page("/ViewTableOfContent",
	...
	public final static Page VIEW_SECTION_DATA_ENTRY_PRINT = new Page(
			"/WEB-INF/jsp/managestudy/viewSectionDataEntryHtml.jsp", "View Section Data Entry Html");

	public final static Page VIEW_SECTION_DATA_ENTRY_SERVLET = new Page("/ViewSectionDataEntry",
			"View Section Data Entry Servlet");

	public final static Page EXPORT_DATA_CUSTOM = new Page("", "Dataset Export");
	public final static Page VIEW_EVENT_CRF_CONTENT = new Page("/WEB-INF/jsp/managestudy/viewEventCRFContent.jsp",
			"View Event CRF Content");

	public final static Page UPDATE_STUDY_EVENT = new Page("/WEB-INF/jsp/managestudy/updateStudyEvent.jsp",
			"Upate Study Event");
	public final static Page UPDATE_STUDY_EVENT_SERVLET = new Page("/UpdateStudyEvent", "Upate Study Event");
	public final static Page UPDATE_STUDY_EVENT_SIGNED = new Page(
	...
	public final static Page DELETE_CRF_VERSION = new Page("/WEB-INF/jsp/admin/deleteCRFVersion.jsp",
			"delete CRF Version");
	...
	public final static Page VIEW_DISCREPANCY_NOTES_IN_STUDY_PRINT = new Page(
	...
	public final static Page DOWNLOAD_ATTACHED_FILE = new Page("/WEB-INF/jsp/submit/downloadAttachedFile.jsp",
			"Download Attached File");

	public final static Page CONFIRM_LOCKING_CRF_VERSION = new Page(
			"/WEB-INF/jsp/managestudy/confirmLockingCRFVersion.jsp", "confirm locking crf version");
	public final static Page CONFIRM_UNLOCKING_CRF_VERSION = new Page(
	...
	public final static Page VIEW_SECTION_DATA_ENTRY_SERVLET_REST_URL = new Page("/ViewSectionDataEntryRESTUrlServlet",
			"View Section Data Entry Servlet for REST Url call");

	public final static Page VIEW_ALL_SITE_DEFAULT_CRF_VERSIONS_PRINT = new Page(
			"/WEB-INF/jsp/managestudy/defaultAllSiteCrfVersionPrint.jsp", "View default crf versions print");
	public final static Page VIEW_DEFAULT_CRF_VERSIONS_PRINT = new Page(
