...
public class DisplayTableOfContentsBean {
	...
	/**
	 * The String we should use to call TableOfContentsServlet in order to display an overview of this.eventCRF. ie
	 * "TableOfContents?ecid=" + this.eventCRF.id + "&action=" + this.action is a GET query which will display the
	 * overview for this event CRF.
	 */
