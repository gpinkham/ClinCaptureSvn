...
public class EventDefinitionCRFBean extends AuditableEntityBean implements Comparable {
	...
	// The Event CRF is hidden from views in the application
	...
	/**
	 * A comma-separated list of null values allowed. Getting this value is deprecated. Use nullValuesList instead.
	 */
	private String nullValues = "";

	/**
	 * An array of null values allowed. Each element is a NullValue object. This property is set in setNullValues.
	 */
