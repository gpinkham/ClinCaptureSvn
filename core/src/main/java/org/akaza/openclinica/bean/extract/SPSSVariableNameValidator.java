 ...
 * <li>If a name is longer than 64 characters, it will be truncated to 64 characters. If it results in non-unique name
 * in a data file, sequential numbers are used to replace its letters at the end. By default, the size of sequential
 * numbers is 3.
...
public class SPSSVariableNameValidator extends NameValidator {
	private final String[] reservedKeywords = { "all", "and", "by", "eq", "ge", "gt", "le", "lt", "ne", "not", "or",
			"to", "with" };
	...
	/**
	 * Given a variable name, this methods returns a valid SPSS variable name and it guarantees the uniqueness of this
	 * name
	 * 
	 * @param variableName
	 *            String
