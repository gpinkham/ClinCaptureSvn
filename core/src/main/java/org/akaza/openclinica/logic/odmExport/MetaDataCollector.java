 ...
 * In this case, Include element references only to external MetadataVersion.</li>
 * <li>ODM XML file contains multiple Study elements - one parent study and its site(s). <br>
 * In this case, Include element can reference to both internal and external MetadataVersion. ODM fields in dataset
 * table are for the study. For site(s), siteOID will be appended automatically.</li>
 * </ul>
 * 
