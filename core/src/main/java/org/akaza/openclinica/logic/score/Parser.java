...
public class Parser {
	 ...
	 * <li>operators +, -, *, /
	 * <li>parenthesises (, )
	 * <li>formula as the pattern that starts with formula name, formula arguments are grouped in parenthesises with
	 * delimiter as ',' For example: sum(item_x,item_y,item_z)
	 * </ul>
	 * 
	 * @param expression
	 * @return
	 ...
	 * @return
	 */
	public ArrayList<ScoreToken> assignVariables(ArrayList<ScoreToken> expression,
	...
	public static String convertToClassName(String packageName, String functionName) {
		...
		return packageName + "." + functionName.substring(0, 1).toUpperCase()
