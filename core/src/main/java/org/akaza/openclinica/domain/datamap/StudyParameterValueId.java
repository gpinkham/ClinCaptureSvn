...
public class StudyParameterValueId extends AbstractMutableDomainObject {
    ...
    public boolean equals(Object other) {
        ...
        return (this.getStudyParameterValueId() == castOther.getStudyParameterValueId())
                && ((this.getStudyId() == castOther.getStudyId())
                || (this.getStudyId() != null
                && castOther.getStudyId() != null
                ...
                && castOther.getParameter() != null && this.getParameter().equals(castOther.getParameter())));
    }
