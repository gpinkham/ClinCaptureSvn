...
public class EmailTriggerService {
	...
	public SimpleTrigger generateEmailSenderTrigger(StudyEventDefinitionBean sedTmp, StudySubjectBean ssb, Date sendEmailDay, int daysBetween, String contactEmail, UserAccountBean uaBean) {
		...
		SimpleTrigger sTrigger = new SimpleTrigger(sedTmp.getName(), triggerGroup, 0, 1);
