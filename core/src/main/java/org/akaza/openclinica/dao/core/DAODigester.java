...
/**
 * <P>
 * Creates an Apache Commons Digester, which parses SQL queries in XML and then stores them in a hashmap, to be accessed
 * later. Idea is to create one XML file per Data Access Object, so that SQL syntax can be abstracted out of the Java
 * JDBC code.
 * </P>
 * 
 * @author thickerson
...
public class DAODigester {
	...
	public void run() throws IOException, SAXException {
		...
		/*
		 * <queries> <query> <name>userDaoInsert</name> <sql>INSERT INTO USER (USER_ID, USER_NAME, USER_PASS) VALUES
		 * (USER_ID_SEQ.NEXTVAL,?,?);</sql> </query> </queries>
		 */
