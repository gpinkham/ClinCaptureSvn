...
public class SubjectDAO extends AuditableEntityDAO {
	 ...
	 * @return All subjects who are male, if <code>gender == 'm'</code>, or all subjects who are female, if
	 *         <code>gender == 'f'</code>, or a blank list, otherwise.
	 */
	 ...
	 * 
	 * @param sb
	 *            The subject to create. <code>true</code> if the father and mother id have been properly set; primarily
	 *            for use with genetic studies. <code>false</code> if the father and mother id have not been properly
	 *            set; primarily for use with non-genetic studies.
	 * @return
	 */
	...
	/**
	 * Create a subject whose father and mother id have been properly set. This is primarily for use when creating
	 * subjects in genetic studies.
	 * 
	 * @param sb
	 *            The subject to create.
	 * @return The created subject, with id set according to the insert id if the operation was successful, or id set to
	 *         0 otherwise.
	 * @deprecated
	 */
	@Deprecated
	...
	/**
	 * Create a subject whose father and mother id have not been properly set. This is primarily for use when creating
	 * subjects in non-genetic studies.
	 * 
	 * @param sb
	 *            The subject to create.
	 * @return The created subject, with id set according to the insert id if the operation was successful, or id set to
