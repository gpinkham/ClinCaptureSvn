...
public class RuleSetDAO extends AuditableEntityDAO {
	...
	public RuleSetBean findByExpression(RuleSetBean ruleSetBean) {
		...
		Context c = ruleSetBean.getTarget().getContext() == null ? Context.OC_RULES_V1 : ruleSetBean.getTarget()
				.getContext();
	...
	public ArrayList<RuleSetBean> findByCrfVersionStudyAndStudyEventDefinition(CRFVersionBean crfVersionBean,
	...
	public ArrayList<RuleSetBean> findByCrfStudyAndStudyEventDefinition(CRFBean crfBean, StudyBean currentStudy,
