...
public class StudySubjectDAO extends AuditableEntityDAO {
	...
	public String findNextLabel(StudyBean studyBean) {
		return findNextLabel(studyBean, null);
	}
	/**
	 * Method that returns the next study subject label.
	 *
	...
	public String findNextLabel(StudyBean studyBean, StudyBean studyToSearch) {
		...
		if (studyToSearch == null) {
			studyToSearch = studyBean;
		}
		...
		} while (findByLabelAndStudy(prefix + separatorParam + numericLabel, studyToSearch).getSubjectId() != 0);
