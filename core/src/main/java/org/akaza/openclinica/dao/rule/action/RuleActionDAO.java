...
public class RuleActionDAO extends AuditableEntityDAO {
	...
	public EntityBean create(EntityBean eb) {
		...
		if (eb instanceof DiscrepancyNoteActionBean) {
			...
			Boolean expressionEvaluates = dnActionBean.getExpressionEvaluatesTo() == null ? true : dnActionBean
		...
		if (eb instanceof EmailActionBean) {
			...
			Boolean expressionEvaluates = emailActionBean.getExpressionEvaluatesTo() == null ? true : emailActionBean
					.getExpressionEvaluatesTo();
