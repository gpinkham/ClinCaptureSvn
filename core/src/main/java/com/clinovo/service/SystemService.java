...
public interface SystemService {
	 ...
	 */
	List<SystemGroup> getAllMainGroups();
	 ...
	 */
	List<SystemGroup> getAllChildGroups(int parentId);
	 ...
	 */
	List<System> getAllProperties(int groupId, Role role);

	/**
	 * Structures and retrieves all groups from the database.
	 * 
	 * @param role
	 *            user role
