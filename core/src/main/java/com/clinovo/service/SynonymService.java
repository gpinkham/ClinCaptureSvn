...
/**
 * Service contract specification for the Synonym service to the DAO.
 *
 */
public interface SynonymService {
	...
	/**
	 * Retrieve a synonym given a valid id.
	 * 
	 * @param synonymId Id of the synonym to retrieve.
	 * 
	 * @return Synonym if it exists, null otherwise
	 */
	Synonym findSynonym(int synonymId);

	/**
	 * Retrieve a synonym given a valid name.
	 * 
	 * @param synonymName Name of the synonym to retrieve.
	 * 
	 * @return Synonym if it exists, null otherwise
	 */
	...
	/**
	 * Delete a specified synonym from storage.
	 * 
	 ...
	 * @return List of synonyms
	 */
	List<Synonym> findSynonym(Dictionary dictionary);
