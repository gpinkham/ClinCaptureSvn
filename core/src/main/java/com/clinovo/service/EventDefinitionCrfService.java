...
public interface EventDefinitionCrfService {
	 ...
	 */
	void deleteEventDefinitionCRF(RuleSetService ruleSetService, StudyEventDefinitionBean studyEventDefinitionBean,
			EventDefinitionCRFBean eventDefinitionCRFBean, Locale locale) throws Exception;
