...
/**
 * This class is the database interface for discrepancy description. It performs the CRUD operations related to discrepancy description.
 * 
 * <p>
 */
@Repository
@SuppressWarnings("unchecked")
public class DiscrepancyDescriptionDAO extends AbstractDomainDao<DiscrepancyDescription> {

	@Override
	public Class<DiscrepancyDescription> domainClass() {
		return DiscrepancyDescription.class;
	}
	...
	public void deleteDiscrepancyDescription(DiscrepancyDescription description) {
		
		this.getCurrentSession().delete(description);
	}
