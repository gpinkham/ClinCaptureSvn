...
public class RuleSetRuleAuditDaoTest extends HibernateOcDbTestCase {
	...
	/*
	 * public void testSaveOrUpdate() { RuleSetRuleAuditDao ruleSetRuleAuditDao = (RuleSetRuleAuditDao)
	 * getContext().getBean("ruleSetRuleAuditDao"); RuleSetRuleDao ruleSetRuleDao = (RuleSetRuleDao)
	 * getContext().getBean("ruleSetRuleDao"); RuleSetRuleBean ruleSetRuleBean = new RuleSetRuleBean();
	 * 
	 * ruleSetRuleBean = ruleSetRuleDao.findById(3); // ruleSetRuleBean.setId(3); RuleSetRuleAuditBean
	 * ruleSetRuleAuditBean = new RuleSetRuleAuditBean(); ruleSetRuleAuditBean.setRuleSetRuleBean(ruleSetRuleBean);
