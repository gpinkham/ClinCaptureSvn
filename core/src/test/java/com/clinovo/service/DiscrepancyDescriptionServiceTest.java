...
public class DiscrepancyDescriptionServiceTest extends DefaultAppContextTest {
	...
	public void testThatFindDDescriptionReturnVisibilityLevel() {
		assertEquals(DiscrepancyVisibility.STUDY.getValue(),
				discrepancyDescriptionService.findById(2).getVisibilityLevel());
	}
	...
	public void testFindAllSortedDescriptionsFromStudyMoreDetailed() {
		...
		assertEquals(1,
				discrepancyDescriptionService.findAllSortedDescriptionsFromStudy(1).get("dnUpdateDescriptions").size());
	}
