...
/**
 * ItemRenderMetadataDAO Test.
 */
public class ItemRenderMetadataDAOTest extends DefaultAppContextTest {
	...
	public void testThatFindByCrfVersionAndItemIDReturnsCorrectWidth() {
		assertEquals(EXPECTED_WIDTH, itemRenderMetadataDAO.findByCrfVersionAndItemID(1, 3).getWidth());
	}

	@Test
	public void testThatFindByCrfVersionAndItemIDReturnsCorrectLeftItemTextWidth() {
		assertEquals(EXPECTED_LEFT_ITEM_TEXT_WIDTH, itemRenderMetadataDAO.findByCrfVersionAndItemID(1, 2).getLeftItemTextWidth());
	}
	...
	public void testThatSaveOrUpdatePersistsANewWidget() {
		...
		itemRenderMetadataDAO.saveOrUpdate(renderMetadata);
