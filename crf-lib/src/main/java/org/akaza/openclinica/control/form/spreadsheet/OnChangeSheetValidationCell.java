...
/**
 * <p>
 * One spreadsheet cell to be validated for instant-calculation func: onChange.<br/>
 * For func: onChange(oriName, optionValue), arguments[0] is origin item name; arguments[1] is optionValue.
 * </p>
 * 
 */
// ywang (Aug., 2011)
public class OnChangeSheetValidationCell {
	...
	/**
	 * final OnChangeSheetValidationType has been set as NONE; onChangeTypeFirst has been set as false;
	...
	/**
	 * onChangeTypeFirst has been set as true. sheetValidationType has been set as NONE.
	 * 
	...
	public void setOriAndOption() {
		String[] al = OnChangeSheetValidationCell.funcOnChangeArguments(sheetValidationCell.getSheetArgumentCell()
				.getSheetCell().getColValue());
