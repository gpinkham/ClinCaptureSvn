...
Replace DBNAME in the above example with the name of your database.  Also, please note that we are using the user name 'clincapture' to access the database.
...
EXAMPLE: /opt/PostgreSQL/8.4/bin/psql -u clincapture -d DBNAME < Duplicate_Delete.sql
...
EXAMPLE: /opt/PostgreSQL/8.4/bin/psql -u clincapture -d DBNAME < Unique_Constraint.sql
Replace DBNAME in the above example with the name of your database.