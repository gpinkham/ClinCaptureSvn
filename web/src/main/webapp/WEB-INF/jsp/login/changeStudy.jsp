...
<h1><span class="title_manage"><fmt:message key="change_your_current_study_site" bundle="${restext}"/> <a href="javascript:openDocWindow('help/1_3_changeStudy_Help.html')"><img src="images/bt_Help_Manage.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></span></h1>
...
<p><fmt:message key="please_choose_study_list" bundle="${restext}"/>:</P>
  ...
  <br>
  <p>
  	  <input type="button" name="BTN_Back" id="GoToPreviousPage" value="<fmt:message key="back" bundle="${resword}"/>" class="button_medium" onClick="javascript: return checkGoBackEntryStatus('DataStatus_bottom', '<fmt:message key="you_have_unsaved_data3" bundle="${resword}"/>');"/>
