                                        ...
                                        <div class="textbox_center">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="formfieldXL_BG"><input type="text" name="name" value="<c:out value="${userBean1.name}"/>" class="formfieldXL"></div>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <div class="formfieldXL_BG"><input type="text" name="email"
                                                ...
                                                <tr valign="top">
                                                    <td class="formlabel"><fmt:message key="password_challenge_question" bundle="${resword}"/>:
                                                    </td>
                                                    <td>
                                                        <div class="formfieldXL_BG">
                                                            <select name="passwdChallengeQuestion" class="formfieldXL">
                                                                <c:forEach var="question" items="${challengeQuestions}">
                                                                    <option value="${question.name}" <c:if test="${previouslySelectedPasswdChallengeQuestion ne null and previouslySelectedPasswdChallengeQuestion eq question.name}">selected</c:if>>${question.name}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <div class="formfieldXL_BG"><input type="text" name="passwdChallengeAnswer" value="<c:out value="${userBean1.passwdChallengeAnswer}"/>" class="formfieldXL"></div>
                                                        <jsp:include page="../showMessage.jsp">
