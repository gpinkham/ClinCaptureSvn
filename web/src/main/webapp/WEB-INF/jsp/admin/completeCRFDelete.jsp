...
<tr id="sidebar_Instructions_open">
    <td class="sidebar_tab">
        ...
        <div class="sidebar_tab_content">
            <fmt:message key="you_are_completely_deleting_a_crf" bundle="${restext}"/>
        </div>
    </td>
</tr>
...
<h1>
	<span class="first_level_header">
		<fmt:message key="confirm_deletion_of_crf" bundle="${resword}"/>: <c:out value="${crfBean.name}"/>
	</span>
</h1>

<p>
    <fmt:message key="this_operation_will_permanently_delete_this_crf" bundle="${restext}"/>
</p>
                                    ...
                                    <div class="tablebox_center">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td class="table_cell">
                                                    <c:out value="${crfBean.description}"/>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td class="table_header_column">
