...
<h1><span class="title_manage"><fmt:message key="preview_crf_failed_ver_already_exists" bundle="${resword}"/></span></h1>
...
<table>
 ...
 <p><fmt:message key="the_crf_with_same_ver_already_exists" bundle="${restext}"/></p></font>
<br>
