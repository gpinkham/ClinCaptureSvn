...
<input type="hidden" name="tname" value="<c:out value="${tname}"/>" />
<table>
	<tr>
	...
	<tr>
		<td class="text"><b><fmt:message key="import_job_study" bundle="${resword}"/>:</b><br><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyId"/></jsp:include></td>
		<td class="text" onChange="javascript:setImageWithTitle('DataStatus_bottom','images/icon_UnsavedData.gif', 'Data has been entered, but not saved. ');">
						<%-- <select name="studyId">
	...
	<tr>
		...
		<td class="text"><input name="filePathDir" type=text value="${filePathDir}" onChange="javascript:setImageWithTitle('DataStatus_bottom','images/icon_UnsavedData.gif', 'Data has been entered, but not saved. ');"/></td>
	</tr>
	...
	<tr>
		...
		<td class="text">
			<input type="text" name="contactEmail" size="90" value="<c:out value="${contactEmail}"/>" onChange="javascript:setImageWithTitle('DataStatus_bottom','images/icon_UnsavedData.gif', 'Data has been entered, but not saved. ');" />
...
<table>
	<tr>
		<td>
		<input type="button" name="btnSubmit" value="<fmt:message key="back" bundle="${resword}"/>" class="button_medium" onClick="checkGoToEntryStatus('DataStatus_bottom', '<fmt:message key="you_have_unsaved_data2" bundle="${resword}"/>','ViewImportJob');" />
		</td>
		<td>
