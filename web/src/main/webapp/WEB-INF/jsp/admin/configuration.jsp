            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top"><div class="formfieldM_BG">
                        <select name=lockswitch class="formfieldM" onchange="javascript:changeIcon();">
                                <c:choose>
    ...
    <tr>
        ...
        <td valign="top">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top"><div class="formfieldM_BG">
                        <input type="text" onchange="javascript:changeIcon();" name="lockcount" value="<c:out value="${lockcount}"/>" size="20" class="formfieldM" />
                    </div></td>
                </tr>
                <tr>
...
<input type="button" onClick="checkGoToEntryStatus('DataStatus_bottom', '<fmt:message key="you_have_unsaved_data2" bundle="${resword}"/>','ListUserAccounts');"  name="cancel" value="   <fmt:message key="back" bundle="${resword}"/>   " class="button_medium"/>
