...
<h1>
	<span class="first_level_header">
		<fmt:message key="confirm_removal_of_study" bundle="${resword}"/>
	</span>
</h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr valign="top">
  ...
  <form action="RemoveStudy?action=submit&id=<c:out value="${studyToRemove.id}"/>" method="POST">
    ...
    <input type="submit" name="submit" value="<fmt:message key="submit" bundle="${resword}"/>" onClick='return confirmSubmit({ message: "<fmt:message key="if_you_remove_this_study" bundle="${restext}"/>", height: 150, width: 500, submit: this });' class="button_long long_submit">
 </form>
