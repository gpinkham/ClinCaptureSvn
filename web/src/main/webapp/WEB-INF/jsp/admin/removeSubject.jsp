...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr valign="top"><td class="table_header_column"><fmt:message key="date_of_birth" bundle="${resword}"/>:</td>
      <td class="table_cell">
		  <cc-fmt:formatDate value="${subjectToRemove.dateOfBirth}"/>
	  </td>
  </tr>
  <tr valign="top"><td class="table_header_column"><fmt:message key="date_created" bundle="${resword}"/>:</td><td class="table_cell">
	  <cc-fmt:formatDate value="${subjectToRemove.createdDate}" dateTimeZone="${userBean.userTimeZoneId}"/>
  </td>
  </tr>
</table>
</div>
