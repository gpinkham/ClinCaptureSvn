...
<table border="0" cellpadding="0" cellspacing="0" width="160" id="sideBarTable">
...
<!-- Side alert, onlu show the content after user logs in -->
 ...
 <c:if test="${userBean != null && userBean.id>0}">	 
  <c:choose>
    ...
    <c:when test="${!empty pageMessages || param.message == 'authentication_failed' || param.message == 'system_no_permission'}">
