...
<c:set var="timeAdditionalStyle" value="${param.timeAdditionalStyle}" />
...
<td valign="top" style="width: 107px;">
    <div class="formfieldS_BG">
        <input type="text" name="<c:out value="${dateFieldName}"/>" value="<c:out value="${date}" />" class="formfieldS" id="${prefix}dateField" onChange="javascript:setImageWithTitle('DataStatus_bottom','images/icon_UnsavedData.gif', 'Data has been entered, but not saved. ');"/>
    </div>
</td>
<td valign="top" style="width: 30px;">
	<ui:calendarIcon onClickSelector="'#${prefix}dateField'" />
</td>

<td valign="top" style="${timeAdditionalStyle}">
...
<td class="formlabel" style="${timeAdditionalStyle}">:</td>
