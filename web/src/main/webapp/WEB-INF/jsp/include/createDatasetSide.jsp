...
<c:when test="${panel.orderedData}">
   ...
   <c:if test="${! EditSelectedSubmitted}"><a href='javascript:void 0' onclick="return confirmSubmit({ message: '<fmt:message key="there_a_total_of" bundle="${resword}"><fmt:param value="${totalNumberOfStudyItems}"/></fmt:message>', height: 150, width: 500, form: document.getElementById('selectAllItems') });"><b><fmt:message key="select_all_items_in_study" bundle="${resword}"/></b></a>
   </c:if>
</c:when>
<c:otherwise>
