...
<div class="formfieldS_BG">
    <input type="text" name="<c:out value="${dateFieldName}"/>" value="<c:out value="${date}" />" class="formfieldS" onChange="javascript:setImageWithTitle('DataStatus_bottom','images/icon_UnsavedData.gif', 'Data has been entered, but not saved. ');" id="${prefix}dateField"/>
</div>
</td>
<td valign="top">
