...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_a_study_description"
	                                                         bundle="${resword}"/></td>
</tr>
<tr valign="top">
	<td class="table_header_column"><b><fmt:message key="brief_title" bundle="${resword}"/></b>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><b><fmt:message key="official_title" bundle="${resword}"/></b>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><b><fmt:message key="secondary_IDs" bundle="${resword}"/></b>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="principal_investigator" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="brief_summary" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="protocol_detailed_description" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="sponsor" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="collaborators" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_b_study_status" bundle="${resword}"/></td>
</tr>

<tr valign="top">
	<td class="table_header_column"><fmt:message key="study_phase" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="protocol_type" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="purpose" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<c:choose>
	<c:when test="${newStudy.protocolTypeKey=='interventional'}">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="allocation" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="masking" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="control" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="assignment" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="endpoint" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="interventions" bundle="${resword}"/>:</td>
			<td class="table_cell">
	...
	<c:otherwise>
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="duration" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="selection" bundle="${resword}"/>:</td>
			<td class="table_cell">
		...
		<tr valign="top">
			<td class="table_header_column"><fmt:message key="timing" bundle="${resword}"/>:</td>
			<td class="table_cell">
...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_c_conditions_and_eligibility"
	                                                         bundle="${resword}"/></td>
</tr>

<tr valign="top">
	<td class="table_header_column"><fmt:message key="conditions" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="keywords" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="eligibility" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<c:if test="${genderShow}">
	<tr valign="top">
		...
		<td class="table_cell"><c:out value="${newStudy.gender}"/> &nbsp;</td>
	</tr>
</c:if>

<tr valign="top">
	<td class="table_header_column"><fmt:message key="minimum_age" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="maximum_age" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="healthy_volunteers_accepted" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="expected_total_enrollment" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_d_facility_information"
	                                                         bundle="${resword}"/></td>
</tr>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="facility_contact_name" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="facility_contact_degree" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="facility_contact_phone" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="facility_contact_email" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_e_related_information"
	                                                         bundle="${resword}"/></td>
</tr>


<tr valign="top">
	<td class="table_header_column"><fmt:message key="MEDLINE_identifier_references" bundle="${resword}"/>:</td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="results_reference" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="URL_reference" bundle="${resword}"/></td>
	<td class="table_cell">
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="URL_description" bundle="${resword}"/></td>
	<td class="table_cell">
...
<tr bgcolor="#F5F5F5">
	<td class="table_header_column" colspan="2"><fmt:message key="section_f_study_parameter_configuration"
	                                                         bundle="${resword}"/></td>
</tr>

<tr valign="top">
	<td class="table_header_column"><fmt:message key="collect_subject_date_of_birth" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="allow_discrepancy_management" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="how_to_generate_the_study_subject_ID" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="show_person_id_on_crf_header" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="when_entering_data" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="interviewer_name_default_as_blank" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="interviewer_name_editable" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="interviewer_date_required" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="interviewer_date_default_as_blank" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="interviewer_date_editable" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="secondary_label_viewable" bundle="${resword}"/></td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	...
	<td class="table_cell">
		${studyToView.studyParameterConfig.dateOfEnrollmentForStudyLabel}
	</td>
</tr>
...
<tr valign="top">
	<td class="table_header_column"><fmt:message key="gender_required2" bundle="${resword}"/>:</td>
	<td class="table_cell">
		<c:choose>
...
<tr valign="top">
	...
	<td class="table_cell">
		${studyToView.studyParameterConfig.startDateTimeLabel}
	</td>
</tr>
...
<tr valign="top">
	...
	<td class="table_cell">
		${studyToView.studyParameterConfig.endDateTimeLabel}
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<input name="defaultBioontologyURL" value=
...
<tr valign="top">
	...
	<td>
		<input name="medicalCodingApiKey" value=
...
<tr valign="top">
	...
	<td class="table_cell">
		<c:choose>
			<c:when test="${studyToView.studyParameterConfig.instnceType == 'development'}">
				<fmt:message key="systemProperty.instanceType.development.radioLabel" bundle="${resword}" />
			</c:when>
			<c:when test="${studyToView.studyParameterConfig.instnceType == 'training'}">
				<fmt:message key="systemProperty.instanceType.training.radioLabel" bundle="${resword}" />
			</c:when>
			<c:when test="${studyToView.studyParameterConfig.production == 'production'}">
				<fmt:message key="systemProperty.instanceType.production.radioLabel" bundle="${resword}" />
			</c:when>
			<c:otherwise>
				${studyToView.studyParameterConfig.instnceType}
			</c:otherwise>
		</c:choose>
	</td>
</tr>
	...
	<tr>
		<td>
			<form action="CreateStudy" method="post">
				...
				<input type="submit" name="Submit" value="<fmt:message key="submit_study" bundle="${resword}"/>"
				       class="button_long">
			</form>
		</td>
		<td>
			<form action="CreateStudy" method="POST">
				...
				<input id="cancel" type="button" name="Cancel"
				       value="<fmt:message key="cancel_creation" bundle="${resword}"/>" class="button_long"
