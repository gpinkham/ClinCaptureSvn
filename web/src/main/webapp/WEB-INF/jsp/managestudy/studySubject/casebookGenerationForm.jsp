...
<div class="table_title_Admin">
    	<a name="global"></a><a href="javascript:leftnavExpand('archivableCasebook');">
            ...
            <fmt:message key="viewStudySubject.casebookGenerationForm.title" bundle="${resword}"/>
        </a>
</div>
        ...
        <div class="tablebox_center">
            <form name="casebookLink">
                <div style="margin-top:0;margin-bottom:10px;" class="connect-widget">
                    <b><fmt:message key="viewStudySubject.casebookGenerationForm.casebookFormat" bundle="${resword}"/></b>
                    <br>
                    ...
                    <input type="radio" value="html/print" id="casebookTypePdf" name="casebookType">
                ...
                <div style="margin-bottom:10px;" class="connect-widget">
                    ...
                    <div style="display:none" id="casebookLinkDisplay"><br>
                        <fmt:message key="viewStudySubject.casebookGenerationForm.button.getLink.description" bundle="${resword}"/><br>
                        <input type="text" id="casebookLinkText" size="100">
                    </div>
                </div>
            </form>
        </div>
