...
<c:choose>
	<c:when test="${group.groupClassTypeId == 4}">
		<c:set var="pageHeader"><fmt:message key="confirm_to_delete_the_dynamic_group_class"  bundle="${resword}"/></c:set>
		<c:set var="pageDescription"><fmt:message key="confirm_deletion_of_this_dynamic_group_class"  bundle="${resword}"/></c:set>
		<c:set var="allertMessage"><fmt:message key="if_you_delete_this_dynamic_group_class"  bundle="${resword}"/></c:set>
	</c:when>
	<c:otherwise>
		<c:set var="pageHeader"><fmt:message key="confirm_to_delete_the_subject_group_class"  bundle="${resword}"/></c:set>
		<c:set var="pageDescription"><fmt:message key="confirm_deletion_of_this_subject_group_class"  bundle="${resword}"/></c:set>
		<c:set var="allertMessage"><fmt:message key="if_you_delete_this_subject_group_class"  bundle="${resword}"/></c:set>
	</c:otherwise>
</c:choose>
...
<br><br>
 <form action='deleteStudyGroupClass?submit=true&id=<c:out value="${group.id}"/>' method="POST">
