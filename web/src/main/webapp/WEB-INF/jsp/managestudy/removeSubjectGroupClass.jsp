...
<h1>
	<span class="first_level_header">
		<fmt:message key="confirm_to_remove_a_subject_group_class"  bundle="${resword}"/>
	</span>
</h1>
...
<c:choose>
 ...
 <form action='RemoveSubjectGroupClass?action=submit&id=<c:out value="${group.id}"/>' method="POST">
    ...
    <input type="submit" name="submit" value="<fmt:message key="submit" bundle="${resword}"/>" class="button_medium medium_submit" onClick='return confirmSubmit({ message: "<fmt:message key="if_you_remove_this_subject_group_class" bundle="${resword}"/>", height: 150, width: 500, submit: this });'>
 </form> 
<br><br>
