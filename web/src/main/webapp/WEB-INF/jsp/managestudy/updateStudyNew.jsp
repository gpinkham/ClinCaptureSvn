...
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    <div class="textbox_center">
        <table border="0" cellpadding="0" cellspacing="0" width="450">
          ...
          <input type="text" name="uniqueProId" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.identifier}"/>" class="formfieldXL"></div>
          ...
          <input type="text" name="name" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.name}"/>" class="formfieldXL"></div>
          ...
          <input type="text" name="officialTitle" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.officialTitle}"/>" class="formfieldXL"></div>
          ...
          <td> <div class="formtextareaXL4_BG">
           <textarea class="formtextareaXL4" name="secondProId" onchange="javascript:changeIcon()" rows="4" cols="50"><c:out value="${studyToView.secondaryIdentifier}"/></textarea></div>
          ...
          <input type="text" name="prinInvestigator" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.principalInvestigator}"/>" class="formfieldXL"></div>
          <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="prinInvestigator"/></jsp:include></td><td>*</td></tr>
            ...
            <textarea class="formtextareaXL4" name="description" onchange="javascript:changeIcon()" rows="4" cols="50"><c:out value="${studyToView.summary}"/></textarea></div>
            <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="description"/></jsp:include></td><td >*</td></tr>
             ...
             <div class="formtextareaXL4_BG"><textarea class="formtextareaXL4" name="protocolDescription" onchange="javascript:changeIcon()" rows="4" cols="50"><c:out value="${studyToView.protocolDescription}"/></textarea></div>
            ...
            <div class="formfieldXL_BG"><input type="text" name="sponsor" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.sponsor}"/>" class="formfieldXL"></div>
            ...
            <div class="formtextareaXL4_BG"><textarea class="formtextareaXL4" name="collaborators" onchange="javascript:changeIcon()" rows="4" cols="50"><c:out value="${studyToView.collaborators}"/></textarea></div>
          ...
          <tr valign="top"><td class="formlabel"><fmt:message key="study_phase" bundle="${resword}"/>:</td><td>
           ...
           <div class="formfieldXL_BG"><select name="phase" class="formfieldXL" onchange="javascript:changeIcon()">
           ...
           <div class="formfieldXL_BG">
               <input type="text" name="protocolDateVerification" onchange="javascript:changeIcon()" value="<c:out value="${protocolDateVerification}"/>" class="formfieldM" id="protocolDateVerificationField"></div>
           ...
           <input type="text" name="startDate" onchange="javascript:changeIcon()" value="<c:out value="${startDate}" />" class="formfieldXL" id="startDateField"></div>
           ...
           <tr valign="top"><td class="formlabel"><fmt:message key="study_completion_date" bundle="${resword}"/>:</td>
               <td><div class="formfieldXL_BG">
           <input type="text" name="endDate" onchange="javascript:changeIcon()" value="<c:out value="${endDate}" />" class="formfieldXL" id="endDateField"></div>
          ...
          <tr valign="top">
              ...
              <td>
                ...
                <div class="formfieldXL_BG"><select name="purpose" class="formfieldXL" onchange="javascript:changeIcon()">
          ...
          <div class="formfieldXL_BG"><select name="allocation" class="formfieldXL" onchange="javascript:changeIcon()">
          ...
          <div class="formfieldXL_BG"><select name="masking" class="formfieldXL" onchange="javascript:changeIcon()">
           <option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
          ...
          <tr valign="top"><td class="formlabel"><fmt:message key="control" bundle="${resword}"/>:</td><td>
             ...
             <div class="formfieldXL_BG"><select name="control" class="formfieldXL" onchange="javascript:changeIcon()">
             <option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
           ...
           <c:set var="assignment1" value="${studyToView.assignment}"/>
            <div class="formfieldXL_BG"><select name="assignment" class="formfieldXL" onchange="javascript:changeIcon()">
            <option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
          ...
          <fmt:message key="study_classification" bundle="${resword}"/></a>:</td><td>
           ...
           <div class="formfieldXL_BG"><select name="endpoint" class="formfieldXL" onchange="javascript:changeIcon()">
           <option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
...
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    ...
    <table border="0" cellpadding="0">
      ...
      <div class="formfieldXL_BG"><input type="text" name="conditions" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.conditions}"/>" class="formfieldXL">
      </div>
      ...
      <tr valign="top"><td class="formlabel"><fmt:message key="keywords" bundle="${resword}"/>:<br>(<fmt:message key="separate_by_commas" bundle="${resword}"/>)</td><td>
       <div class="formtextareaXL4_BG"><textarea name="keywords" onchange="javascript:changeIcon()" rows="4" cols="50"  class="formtextareaXL4"><c:out value="${studyToView.keywords}"/></textarea>
       </div>
      ...
      <tr valign="top"><td class="formlabel"><fmt:message key="eligibility_criteria" bundle="${resword}"/>:</td><td>
       <div class="formtextareaXL4_BG"><textarea name="eligibility" onchange="javascript:changeIcon()" rows="4" cols="50" class="formtextareaXL4"><c:out value="${studyToView.eligibility}"/></textarea>
       </div>
      ...
      <div class="formfieldXL_BG"><input type="text" name="ageMin" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.ageMin}"/>" class="formfieldXL"></div>
      ...
      <div class="formfieldXL_BG"><input type="text" name="ageMax" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.ageMax}"/>" class="formfieldXL"></div>
      ...
      <tr valign="top"><td class="formlabel"><fmt:message key="healthy_volunteers_accepted" bundle="${resword}"/>:</td><td>
       <div class="formfieldXL_BG"><select name="healthyVolunteerAccepted" class="formfieldXL" onchange="javascript:changeIcon()">
        <c:choose>
      ...
      <div class="formfieldXL_BG"><input type="text" name="expectedTotalEnrollment" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.expectedTotalEnrollment}"/>" class="formfieldXL"">
...
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    ...
    <tr valign="top"><td class="formlabel"><fmt:message key="facility_name" bundle="${resword}"/>:</td><td><div class="formfieldXL_BG">
      <input type="text" name="facName" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityName}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facCity" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityCity}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facState" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityState}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facZip" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityZip}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facCountry" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityCountry}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facConName" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityContactName}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facConDegree" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityContactDegree}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facConPhone" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityContactPhone}"/>" class="formfieldXL"></div>
      ...
      <input type="text" name="facConEmail" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.facilityContactEmail}"/>" class="formfieldXL"></div>
...
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    ...
    <table border="0" cellpadding="0">
      ...
      <div class="formfieldXL_BG"><input type="text" name="medlineIdentifier" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.medlineIdentifier}"/>" class="formfieldXL"></div>
      ...
      <tr valign="top"><td class="formlabel"><fmt:message key="results_reference" bundle="${resword}"/>:</td><td>
       <div class="formfieldS_BG"><select name="resultsReference" class="formfieldS" onchange="javascript:changeIcon()">
        <c:choose>
      ...
      <div class="formfieldXL_BG"><input type="text" name="url" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.url}"/>" class="formfieldXL"></div>
      ...
      <div class="formfieldXL_BG"><input type="text" name="urlDescription" onchange="javascript:changeIcon()" value="<c:out value="${studyToView.urlDescription}"/>" class="formfieldXL"></div>
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top"><td class="formlabel"><fmt:message key="interviewer_date_default_as_blank" bundle="${resword}"/></td><td>
   ...
   <c:when test="${studyToView.studyParameterConfig.interviewDateDefault== 'blank'}">
    ...
    <input type="radio" onchange="javascript:changeIcon()" name="interviewDateDefault" value="pre-populated"><fmt:message key="pre_populated_from_SE" bundle="${resword}"/>
...
<input type="button" name="BTN_Back" id="GoToPreviousPage" value="<fmt:message key="back" bundle="${resword}"/>" class="button_medium" onClick="javascript: return checkGoToEntryStatus('DataStatus_bottom', '<fmt:message key="you_have_unsaved_data3" bundle="${resword}"/>','pages/studymodule');"/>
</td>
<td>
