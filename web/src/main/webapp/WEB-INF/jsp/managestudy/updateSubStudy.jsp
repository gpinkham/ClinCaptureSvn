  ...
  <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="statusId"/></jsp:include></td></tr>
   ...
   <c:if test="${paramsMap['allowCodingVerification'] != null}">
       <tr valign="top">
           ...
           <td>
               <input type="radio" <c:if test="${paramsMap['allowCodingVerification'] == 'yes'}">checked</c:if> name="allowCodingVerification" value="yes"><fmt:message key="yes" bundle="${resword}"/>
               <input type="radio" <c:if test="${paramsMap['allowCodingVerification'] == 'no'}">checked</c:if> name="allowCodingVerification" value="no"><fmt:message key="no" bundle="${resword}"/>
           </td>
       </tr>
       <tr>
          <td>&nbsp;</td>
