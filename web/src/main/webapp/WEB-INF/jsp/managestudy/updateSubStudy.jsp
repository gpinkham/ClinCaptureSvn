  ...
  <c:forEach var="config" items="${newStudy.studyParameters}">
   ...
   <c:when test="${config.parameter.handle=='discrepancyManagement'}">
    ...
    <c:when test="${config.parameter.handle=='autoScheduleEventDuringImport'}">
      <tr valign="top">
        ...
        <td>
          <input type="radio" <c:if test="${config.value.value== 'yes'}">checked</c:if> name="autoScheduleEventDuringImport" value="yes"><fmt:message key="yes" bundle="${resword}"/>
          <input type="radio" <c:if test="${config.value.value== 'no'}">checked</c:if> name="autoScheduleEventDuringImport" value="no"><fmt:message key="no" bundle="${resword}"/>
        </td>
      </tr>
    </c:when>
    <c:when test="${config.parameter.handle=='autoCreateSubjectDuringImport'}">
      <tr valign="top">
        ...
        <td>
          <input type="radio" <c:if test="${config.value.value== 'yes'}">checked</c:if> name="autoCreateSubjectDuringImport" value="yes"><fmt:message key="yes" bundle="${resword}"/>
          <input type="radio" <c:if test="${config.value.value== 'no'}">checked</c:if> name="autoCreateSubjectDuringImport" value="no"><fmt:message key="no" bundle="${resword}"/>
        </td>
      </tr>
    </c:when>
   ...
   <c:when test="${config.parameter.handle=='replaceExisitingDataDuringImport'}">
       <tr valign="top">
           ...
           <td>
               <input type="radio" <c:if test="${config.value.value== 'yes'}">checked</c:if> name="replaceExisitingDataDuringImport" value="yes"><fmt:message key="yes" bundle="${resword}"/>
               <input type="radio" <c:if test="${config.value.value== 'no'}">checked</c:if> name="replaceExisitingDataDuringImport" value="no"><fmt:message key="no" bundle="${resword}"/>
           </td>
       </tr>
   </c:when>
