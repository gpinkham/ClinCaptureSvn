            ...
            <table border="0" cellpadding="0" cellspacing="0">
				<tr valign="top"><td class="formlabel"><fmt:message key="name" bundle="${resword}"/>:</td><td><table><tr><td>
 				<div class="formfieldXL_BG"><input type="text" name="name" onchange="javascript:changeIcon();" value="<c:out value="${definition.name}"/>" class="formfieldXL"></div>
 				 </td><td class="formlabel">*</td><td><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="name"/></jsp:include></td></tr></table></td>
 				 </tr>
...
<tr valign="top">
    <td class="table_cell" colspan="2">
        ...
        <c:choose>
            ...
            <c:otherwise><input onchange="javascript:changeIcon();" checked="checked" type="checkbox" name="hideCRF<c:out value="${count}"/>" value="yes"></c:otherwise>
        </c:choose>
    </td>
