    ...
    <td>
      <c:choose>
        <c:when test="${studyToView.studyParameterConfig.autoScheduleEventDuringImport == 'yes'}">
          <input type="radio" checked name="autoScheduleEventDuringImport" value="yes"><fmt:message key="yes" bundle="${resword}"/>
          <input type="radio" name="autoScheduleEventDuringImport" value="no"><fmt:message key="no" bundle="${resword}"/>
        </c:when>
        <c:otherwise>
          <input type="radio" name="autoScheduleEventDuringImport" value="yes"><fmt:message key="yes" bundle="${resword}"/>
          <input type="radio" checked name="autoScheduleEventDuringImport" value="no"><fmt:message key="no" bundle="${resword}"/>
        </c:otherwise>
      </c:choose>
    </td>
  </tr>
      ...
      <td>
          <c:choose>
              <c:when test="${studyToView.studyParameterConfig.medicalCodingApprovalNeeded == 'yes'}">
                  <input type="radio" checked name="medicalCodingApprovalNeeded" value="yes"><fmt:message key="yes" bundle="${resword}"/>
                  <input type="radio" name="medicalCodingApprovalNeeded" value="no"><fmt:message key="no" bundle="${resword}"/>
              </c:when>
              <c:otherwise>
                  <input type="radio" name="medicalCodingApprovalNeeded" value="yes"><fmt:message key="yes" bundle="${resword}"/>
                  <input type="radio" checked name="medicalCodingApprovalNeeded" value="no"><fmt:message key="no" bundle="${resword}"/>
              </c:otherwise>
          </c:choose>
      </td>
  </tr>
      ...
      <td>
          <c:choose>
              <c:when test="${studyToView.studyParameterConfig.medicalCodingContextNeeded == 'yes'}">
                  <input type="radio" checked name="medicalCodingContextNeeded" value="yes"><fmt:message key="yes" bundle="${resword}"/>
                  <input type="radio" name="medicalCodingContextNeeded" value="no"><fmt:message key="no" bundle="${resword}"/>
              </c:when>
              <c:otherwise>
                  <input type="radio" name="medicalCodingContextNeeded" value="yes"><fmt:message key="yes" bundle="${resword}"/>
                  <input type="radio" checked name="medicalCodingContextNeeded" value="no"><fmt:message key="no" bundle="${resword}"/>
              </c:otherwise>
          </c:choose>
      </td>
  </tr>
