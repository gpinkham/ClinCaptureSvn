...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
 ...
 <form action='RestoreSubjectGroupClass?action=submit&id=<c:out value="${group.id}"/>' method="POST">
    ...
    <input type="button" onclick="javascript:window.location.href='RemoveSubjectGroupClass'"  name="back" value="<fmt:message key="back" bundle="${resword}"/>   " class="button_medium"/>   
