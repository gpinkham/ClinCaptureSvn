...
<!-- *JSP* submit/addExistingSubject.jsp -->
...
<table border="0" cellpadding="5">
	<tr valign="top">
		<td class="formlabel"><fmt:message key="unique_identifier" bundle="${resword}"/><br> (${study.studyParameterConfig.studySubjectIdLabel}):</td>
		<td valign="top">
	...
	<tr valign="top" style="${additionalStyle}">
		<td class="formlabel">${study.studyParameterConfig.dateOfEnrollmentForStudyLabel} <b><c:out value="${study.name}" />:</td>
	  	<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
