...
<tr>
        ...
        <b><a
          ...
          value="${toc.crf.name}" /> <c:out value="${toc.crfVersion.name}" />
            ...
            <c:when test="${eventCRF.stage.doubleDE_Complete}">
                <c:choose>
                    <c:when test="${studyEvent ne null and studyEvent.subjectEventStatus.signed}">
    ...
    <td class="table_header_row_left" style="color: #789EC5">
        <font color="#CC0000"><c:out value="${openNum}"/> <fmt:message key="open" bundle="${resword}"/></font>,
        <font color="#D4A718"><c:out value="${updatedNum}"/> <fmt:message key="updated" bundle="${resword}"/></font>,
        <font color="#000000"><c:out value="${resolvedNum}"/> <fmt:message key="resolved" bundle="${resword}"/></font>,
        <br><font color="#7CB98F"><c:out value="${closedNum}"/> <fmt:message key="closed" bundle="${resword}"/></font>,
        <font color="#000000"><c:out value="${notAppNum}"/> <fmt:message key="not_applicable" bundle="${resword}"/></font>
    </td>

</tr>
<tr>
    <td class="table_cell_left" style="color: #789EC5">
        <b>${studySubjectLabel}:</b><br />
    </td>
    <td class="table_cell_left" style="color: #789EC5">
...
<tr>
    ...
    <td class="table_cell_noborder" style="color: #789EC5">
        ...
        <c:if test="${genderShow}">
            <span style="padding-left:6px;padding-right:6px"><b>${genderLabel}:</b></span>
            <c:choose>
