...
<!-- *JSP* submit/showFixedItemInput.jsp -->
...
<c:if test='${inputType == "text"}'>
	<input type="text" name="input<c:out value="${itemId}" />" value="<c:out value="${inputTxtValue}"/>" <c:out value="${respLayout}"/> style="background:white;color:#4D4D4D;"/>
</c:if>
