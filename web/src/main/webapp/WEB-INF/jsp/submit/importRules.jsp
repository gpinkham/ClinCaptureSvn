...
<div>&nbsp;</div>
<div class="homebox_bullets"><%-- <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/study-setup')"><fmt:message key="rule_import_rules_documentation" bundle="${resterm}"/></a> --%></div>
