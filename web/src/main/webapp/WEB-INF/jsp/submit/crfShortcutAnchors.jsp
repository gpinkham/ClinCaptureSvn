...
<div id="crfShortcutAnchors_${rowCount}item_${crfShortcutAnchorsId}" field="${inputName}" class="hidden">
    ...
    <c:if test="${di.data ne null && di.metadata ne null && di.data.id > 0 && section.eventCRF.stage.doubleDE_Complete && di.metadata.showItem && di.edcItemMetadata.sdvRequired() && (userRole.studyAdministrator || userRole.monitor)}">
