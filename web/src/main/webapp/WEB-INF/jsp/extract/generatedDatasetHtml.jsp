...
<table border="0" cellpadding="0" cellspacing="0">
  <tr valign="top">
    ...
    <c:if test="${dataset.showSubjectGender and genderShow}">
       <td class="table_header_row">${genderLabel}</td>
    </c:if>
    ...
    <c:if test="${dataset.showSubjectSecondaryId and secondaryIdShow}">
