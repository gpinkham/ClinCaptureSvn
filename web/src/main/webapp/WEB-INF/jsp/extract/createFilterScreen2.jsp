...
<h1>
	<span class="first_level_header">
		<fmt:message key="create_filters" bundle="${resword}"/>: <fmt:message key="instructions" bundle="${resword}"/> 
		<a href="javascript:openDocWindow('help/3_4_createFilter_Help.html')">
