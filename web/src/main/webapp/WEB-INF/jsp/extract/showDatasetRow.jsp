                    ...
                    <c:when test='${currRow.bean.status.name == "removed"}'>
                        ...
                        <td>
                        	<a href="RestoreDataset?dsId=<c:out value="${currRow.bean.id}"/>"
                            	...
                            	<img name="bt_Restore3" src="images/bt_Restore.gif" border="0" alt="<fmt:message key="restore" bundle="${resword}"/>" title="<fmt:message key="restore" bundle="${resword}"/>" align="left" hspace="6">
                           	</a>
                        </td>
                        <td></td>
                    </c:when>
                ...
                <c:choose>
                    <c:when test='${currRow.bean.status.name == "removed"}'>
                        ...
                        <td><a href="RestoreDataset?dsId=<c:out value="${currRow.bean.id}"/>"
                            ...
                            onMouseUp="javascript:setImage('bt_Restore3','images/bt_Restore.gif');"
                            data-cc-datasetId="${currRow.bean.id}"
                            onclick="setAccessedObjected(this)"><img name="bt_Restore3" src="images/bt_Restore.gif" border="0" alt="<fmt:message key="restore" bundle="${resword}"/>" title="<fmt:message key="restore" bundle="${resword}"/>" align="left" hspace="6"></a></td>
                        <td></td>
                        </c:when>
                        <c:otherwise>
                         <td></td><td>&nbsp;</td>   
