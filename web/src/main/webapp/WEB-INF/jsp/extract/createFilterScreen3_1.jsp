...
<h1>
	<span class="first_level_header">
		<fmt:message key="create_filter" bundle="${resword}"/>: <fmt:message key="select_section" bundle="${resworkflow}"/> 
		<a href="javascript:openDocWindow('help/3_4_createFilter_Help.html#step2')">
