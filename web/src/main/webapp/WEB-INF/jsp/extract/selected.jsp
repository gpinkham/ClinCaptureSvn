...
<span class="table_title_Manage"><fmt:message key="subject_attributes" bundle="${resword}"/></span>
...
<span class="table_title_Manage"><fmt:message key="event_attributes" bundle="${resword}"/></span>
...
<span class="table_title_Manage"><fmt:message key="CRF_attributes" bundle="${resword}"/></span>
...
<span class="table_title_Manage"><fmt:message key="subject_group_attributes" bundle="${resword}"/></span>
...
<span class="table_title_Manage"><fmt:message key="CRF_data" bundle="${resword}"/></span>
