...
<script type="text/javascript" language="JavaScript">
	...
	function DisplaySectionTabs() {
		...
		while (TabID <= TabsNumber) {
			...
			url = "${formAction}?eventCRFId=" + <c:out value="${section.eventCRF.id}"/> +"&sectionId=" + sectionId + "&tabId=" + TabID + "${justCloseWindow ? '&cw=1' : ''}" + '${hideSaveAndNextButton == "true" ? "&hideSaveAndNextButton=true" : ""}';
