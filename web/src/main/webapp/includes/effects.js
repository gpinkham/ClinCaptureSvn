...
Element.collectTextNodes = function(element) {
	return $A(prt$(element).childNodes)
			.collect(
					function(node) {
...
Element.collectTextNodesIgnoreClass = function(element, className) {
	return $A(prt$(element).childNodes).collect(
			function(node) {
				return (node.nodeType == 3 ? node.nodeValue : ((node
...
Element.getInlineOpacity = function(element) {
	return prt$(element).style.opacity || '';
}
...
var Effect = {
	...
	multiple : function(element, effect) {
		...
		if (((typeof element == 'object') || (typeof element == 'function'))
			...
			elements = prt$(element).childNodes;
...
Effect.Base.prototype = {
	...
	start : function(options) {
		function codeForEvent(options, eventName) {
			return ((options[eventName + 'Internal'] ? 'this.options.'
					+ eventName + 'Internal(this);' : '') + (options[eventName]
		...
		eval('this.render = function(pos){ '
				...
				+ this.options.from + ';' + 'this.position=pos;'
	...
	loop : function(timePos) {
		if (timePos >= this.startOn) {
			...
			var pos = (timePos - this.startOn) / this.totalTime, frame = Math
					.round(pos * this.totalFrames);
...
Effect.SlideDown = function(element) {
	element = prt$(element).cleanWhitespace();
...
Object.extend(Effect.Transform.prototype, {
	...
	play : function() {
		return new Effect.Parallel(this.tracks.map(function(track) {
			var elements = [prt$(track.ids) || $prt$(track.ids)].flatten();
...
['getInlineOpacity', 'forceRerendering', 'setContentZoom', 'collectTextNodes',
		'collectTextNodesIgnoreClass', 'morph'].each(function(f) {
