...
public class CasebooksTableFactory extends AbstractTableFactory {
    ...
    protected void configureColumns(TableFacade tableFacade, Locale locale) {
        ...
        configureColumn(row.getColumn(SITE_NAME), getMessageSource().getMessage("site_name", null, locale), null, null, true, true);
        ...
        configureColumn(row.getColumn(SUBJECT_STATUS), getMessageSource().getMessage("subject_status", null, locale), null, null, true, true);
    ...
    public void setDataAndLimitVariables(TableFacade tableFacade) {
        ...
        for (StudySubjectBean studySubjectBean : studySubjectBeanList) {
            ...
            h.put(SUBJECT_STATUS, studySubjectBean.getStatus().getName());
