...
public class UpdateStudySubjectServlet extends SecureController {
	...
	public static final String UPDATE_STUDY_SUBJECT = "UpdateStudySubject";
	public static final String UPDATE_STUDY_SUBJECT_REFERER = "updateStudySubjectReferer";
					...
					for (int i = 0; i < groups.size(); i++) {
						...
						if (sgc.getStudyGroupId() == 0) {
							...
							for (Iterator it = subjectGroups.iterator(); it.hasNext();) {
								SubjectGroupMapBean bean = (SubjectGroupMapBean) it.next();
