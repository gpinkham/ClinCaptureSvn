...
/**
 * <P>
 * Meant to serve as the specify parameters and specify criteria for the create filter process (Screens 3 and 4).
 * 
 * @author thickerson
 * 
 */
		...
		if (StringUtil.isBlank(action)) {
			...
			while (q_it.hasNext()) {
				...
				if ("remove".equals(fp.getString(remString))) {
					...
					fob.setItemName(ifmBean.getHeader() + " " + ifmBean.getLeftItemText() + " "
			...
			if ("Specify Filter Metadata".equals(sub)) {
				...
				// Adding parents here to finish off other
