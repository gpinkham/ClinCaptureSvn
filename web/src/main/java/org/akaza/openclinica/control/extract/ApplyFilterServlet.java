...
/**
 * <P>
 * Meant to be the gateway between creating a dataset and applying (or creating) a filter to go on top of the dataset.
 * <P>
 * Ideally, will only consist of a couple of steps; and then will send on to a different servlet to either a) create the
 * filter, or b) add a selected filter and go back to the dataset creation process.
 * <P>
 * 
 * @author thickerson
 * 
