...
public class StudySubjectStatusStatisticsTableFactory extends AbstractTableFactory {
	...
	public void setDataAndLimitVariables(TableFacade tableFacade) {
		...
		for (Status status : statuses) {
			Integer totalStudySubjectsByStatus = studySubjectDao.getCountofStudySubjectsBasedOnStatus(currentStudy,
					status);

			Long percentage = totalStudySubjects == 0 ? 0 : Math
					.round((totalStudySubjectsByStatus.doubleValue() / totalStudySubjects.doubleValue()) * 100);
