...
/**
 * <P>
 * Meant to fill in steps 5 and 6 of the create filter process, that is, to serve as spcifying the metadata and saving
 * the filter, returning to list filters when the process is done.
 * 
 * @author thickerson
 * 
 */
