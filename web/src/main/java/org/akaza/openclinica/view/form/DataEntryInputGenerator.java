...
/**
 * This class creates various types of input fields such as text inputs and select lists. It is used by a class such as
 * HorizontalFormBuilder to dynamically generate HTML tables.
 */
...
public class DataEntryInputGenerator implements InputGenerator {
	...
	public static String ONCHANGE_TEXT_INPUT = "this.className='changedField';setImage('DataStatus_top','images/icon_UnsavedData.gif');setImage('DataStatus_bottom','images/icon_UnsavedData.gif');";
	// for radio buttons only; to deal with an IE/repetition model bug
	public static String ONCHANGE_TEXT_INPUT_RADIOS = "if(! detectIEWindows(navigator.userAgent)){this.className='changedField';}setImage('DataStatus_top','images/icon_UnsavedData.gif');setImage('DataStatus_bottom','images/icon_UnsavedData.gif');";

	/**
	 * This method generates a text input field for a cell inside an HTML table. Like the other methods, the user passes
	 * in a reference to the Element object, and the object receives new attributes and content. Then the method returns
	 * the altered Element object.
	 */
	public Element createTextInputTag(Element tdCell, Integer itemId, Integer tabNumber, String defaultValue,
	...
	/**
	 * This method generates a checkbox tag for a cell inside an HTML table. Like the other methods, the user passes in
	 * a reference to the Element object, and the object receives new attributes and content. Then method returns the
	 * altered Element object. TODO: this code needs to be refactored to separate the domain or business rules from the
	 * rest of the parameters (e.g., isHorizontal)
	 */
	public Element createCheckboxTag(Element tdCell, Integer itemId, List options, Integer tabNumber,
			boolean includeLabel, String dbValue, String defaultValue, boolean isHorizontal, boolean hasSavedData) {
		Element element;
	...
	/**
	 * This method generates a radio button field for a cell inside an HTML table. The options parameter contains
	 * ResponseOptionBeans, which provides the "checked" value for the tag, as well as its accompanying text. Like the
	 * other methods, the user passes in a reference to the Element object, and the object receives new attributes and
	 * content. Then the method returns the altered Element object.
	 */
	public Element createRadioButtonTag(Element tdCell, Integer itemId, List options, Integer tabNumber,
			boolean includeLabel, String dbValue, String defaultValue, boolean isHorizontal, boolean hasSavedData) {
		Element element;
		...
		for (Object responseOptBean : options) {
			...
			if (!hasSavedData && defaultValue != null
					&& (forDefVal.equalsIgnoreCase(defaultValue) || value.equalsIgnoreCase(defaultValue))) {
				element.setAttribute("checked", "checked");
			}
	...
	/*
	 * This method generates a single select tag for a cell inside an HTML table. Like the other methods, the user
	 * passes in a reference to the Element object, and the object receives new attributes and content. Then the method
	 * returns the altered Element object. The options List contains ResponseOptionBeans, which represent each option
	 ...
	 */
	public Element createSingleSelectTag(Element tdCell, Integer itemId, List options, Integer tabNumber,
			String defaultValue, String databaseValue, boolean hasSavedData) {
	...
	public Element createMultiSelectTag(Element tdCell, Integer itemId, List options, Integer tabNumber,
	...
	/**
	 * This method generates a textarea tag for a cell inside an HTML table. Like the other methods, the user passes in
	 * a reference to the Element object, and the object receives new attributes and content. Then the method returns
	 * the altered Element object.
	 */
	public Element createTextareaTag(Element tdCell, Integer itemId, Integer tabNumber, String dbValue,
	 ...
	 * @return
	 */
	public Element createCaculationTag(Element tdCell, Integer itemId, ResponseSetBean responseSet, boolean isDateType,
	...
	public Element createDiscrepancyNoteSymbol(Integer numDiscrepancyNotes, Integer tabNumber, Integer itemDataId,
			Integer itemId, boolean forPrinting) {
