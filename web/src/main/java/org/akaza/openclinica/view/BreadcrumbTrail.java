 ...
 * forwardPage() method in the SecureController servlet, Keep track of metadata being sent in the request, so that users
...
public class BreadcrumbTrail {
		...
		try {
			if (jspPage.equals(Page.CREATE_DATASET_1)) {
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"), "ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("create_dataset_instructions"), "CreateDataset"
						+ this.generateURLString(request), Status.PENDING));// 0
				trail.add(new BreadcrumbBean(resworkflow.getString("select_items_event"), "CreateDataset",
						Status.UNAVAILABLE));// 1
				trail.add(new BreadcrumbBean(resworkflow.getString("define_temporal_scope"), "CreateDataset",
						Status.UNAVAILABLE));// 2
				trail.add(new BreadcrumbBean(resworkflow.getString("specify_dataset_properties"), "CreateDataset",
						Status.UNAVAILABLE));// 3
				trail.add(new BreadcrumbBean(resworkflow.getString("confirm_dataset_properties"), "CreateDataset",
						Status.UNAVAILABLE));// 4
				trail.add(new BreadcrumbBean(resworkflow.getString("generate_dataset"), "CreateDataset",
						Status.UNAVAILABLE));// 5, 6
				// items
				// total
				...
				if (request.getAttribute("id") != null) {
					trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), "ViewStudySubject?id="
							+ (String) request.getAttribute("id"), Status.AVAILABLE));
				} else {
					trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), "ViewStudySubject"
							+ this.generateURLString(request), Status.AVAILABLE));
				}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("submit_data"), "ListStudySubjectsSubmit",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("enroll_subject_instructions"),
						"AddNewSubject?instr=1", Status.PENDING));
				trail.add(new BreadcrumbBean(resworkflow.getString("enroll_subject"), "AddNewSubject",
						Status.UNAVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("add_new_study_event"), "CreateNewStudyEvent",
						Status.UNAVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("study_event_overview"), "EnterDataForStudyEvent",
						Status.UNAVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents",
						Status.UNAVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry",
						Status.UNAVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("mark_event_CRF_complete"), "MarkEventCRFComplete",
						Status.UNAVAILABLE));
			} else if (jspPage.equals(Page.ADD_NEW_SUBJECT)) {
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("enroll_subject"),
						"AddNewSubject", Status.PENDING), 2);
				closeRestOfTrail(2);
				...
				if (!containsServlet("AddNewSubject")) {
					...
					trail.add(new BreadcrumbBean(resworkflow.getString("add_new_study_event"), "CreateNewStudyEvent",
							Status.PENDING));
					trail.add(new BreadcrumbBean(resworkflow.getString("study_event_overview"),
							"EnterDataForStudyEvent", Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents",
							Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry",
							Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("mark_event_CRF_complete"),
							"MarkEventCRFComplete", Status.UNAVAILABLE));
				} else {
					trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("add_new_study_event"),
							"CreateNewStudyEvent", Status.PENDING), 3);
					closeRestOfTrail(3);
				}
				...
				if (containsServlet("AddNewSubject")) {
					ordinal = 4;
					trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("study_event_overview"),
							"EnterDataForStudyEvent" + generateURLString(request), Status.PENDING), ordinal);
					...
					trail.add(new BreadcrumbBean(resworkflow.getString("submit_data"), "ListStudySubjectsSubmit",
							Status.AVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("study_event_overview"),
							"EnterDataForStudyEvent" + generateURLString(request), Status.PENDING));
					trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents",
							Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry",
							Status.UNAVAILABLE));
				...
				if (containsServlet("EnterDataForStudyEvent")) {
					...
					trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"),
							"TableOfContents" + this.generateURLString(request), Status.PENDING), ordinal);
					closeRestOfTrail(ordinal);
				} else {
					ordinal = 1;
					trail = new ArrayList();
					trail.add(new BreadcrumbBean(resworkflow.getString("submit_data"), "ListStudySubjectsSubmit",
							Status.AVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents"
							+ generateURLString(request), Status.PENDING));
					trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry",
							Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("mark_event_CRF_omplete"),
							"MarkEventCRFComplete", Status.UNAVAILABLE));
				}
				closeRestOfTrail(ordinal);
				...
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("mark_event_CRF_complete"),
						"MarkEventCRFComplete" + this.generateURLString(request), Status.PENDING), ordinal);
				closeRestOfTrail(ordinal);
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("conditions_and_eligibility"), "#",
						Status.UNAVAILABLE));
				...
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_study"), "ManageStudy", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_event_definitions"), "ListEventDefinition",
						Status.PENDING));
			}
				...
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_study"), "ManageStudy", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_groups"), "ListSubjectGroupClass",
						Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_groups"), "ListSubjectGroupClass",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("create_subject_group_class"),
						"CreateSubjectGroupClass", Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_subjects"), "ListSubject",
						Status.PENDING));
			} else if (jspPage.equals(Page.LIST_USER_ACCOUNTS)) {
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("business_admin"), "AdminSystem", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_users"), "ListUserAccounts",
						Status.PENDING));
				...
				advanceTrail(trail,
						new BreadcrumbBean(resworkflow.getString("upload_spreadsheet"), "#", Status.PENDING), 0);
				closeRestOfTrail(0);

			} else if (jspPage.equals(Page.UPLOAD_CRF_VERSION)) {

				advanceTrail(trail,
						new BreadcrumbBean(resworkflow.getString("upload_spreadsheet"), "#", Status.PENDING), 1);
				...
				advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("validate_spreadsheet"), "#",
						Status.PENDING), 3);
				closeRestOfTrail(3);
			} else if (jspPage.equals(Page.CREATE_CRF_VERSION_CONFIRMSQL)) {
				advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("review_new_items"), "#", Status.PENDING),
						4);
				closeRestOfTrail(4);
			} else if (jspPage.equals(Page.CREATE_CRF_VERSION_DONE) || jspPage.equals(Page.CREATE_CRF_VERSION_ERROR)) {
				advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("review_SQL_generated"), "#",
						Status.PENDING), 5);
				closeRestOfTrail(5);
				...
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_CRFs"), "ListCRF", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("restore_CRF_version"), "RestoreCRFVersion",
						Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_users"), "ListUserAccounts",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("view_user_account"), "ViewUserAccount"
						+ generateURLString(request), Status.PENDING));
			}

			else if (jspPage.equals(Page.EDIT_ACCOUNT)) {
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_system"), "AdminSystem",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_users"), "ListUserAccounts",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("edit_user_account"), "EditUserAccount"
						+ generateURLString(request), Status.PENDING));
				trail.add(new BreadcrumbBean(resworkflow.getString("confirm_user_account_details"), "EditUserAccount",
						Status.UNAVAILABLE));
			}

			else if (jspPage.equals(Page.EDIT_ACCOUNT_CONFIRM)) {
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("confirm_user_account_details"),
						"EditUserAccount" + generateURLString(request), Status.PENDING), 3);
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_users"), "ListUserAccounts",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("edit_user_role"), "EditStudyUserRole",
						Status.PENDING));
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("administer_users"), "ListUserAccounts",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("create_user_account"), "CreateUserAccount",
						Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_event_definitions"), "ListEventDefinition",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("create_study_event_definition"), "#",
						Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_event_definitions"), "ListEventDefinition",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("update_study_event_definition"), "#",
						Status.PENDING));
				...
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_CRFs"), "ListCRF", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("view_CRF_version_section_data"), "#",
						Status.PENDING));
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("import_rules_2"), "ViewRuleAssignment",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("import_rules_3"), "#", Status.AVAILABLE));
			} else if (jspPage.equals(Page.TEST_RULES)) {
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("test_rules_validate"), "ManageStudy",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("test_rules_test"), "ManageStudy", Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("test_rules_get_results"), "TestRule",
						Status.AVAILABLE));
			}
	 ...
	 * @return <code>true</code> if one of the elements refers to the specified servlet, <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * It is recommended that this method be called after advanceTrail. Using this method ensures that if the user got
	 * to the current page by "going back" through the trail, all the "future" pages will be marked unavailable.
	 * 
	 * @param ordinal
	...
	/**
	 * Makes all breadcrumbs previous to this one open. Good for when you have to skip a few steps ahead.
	 * 
	 * @author thickerson
	 * @param ordinal
