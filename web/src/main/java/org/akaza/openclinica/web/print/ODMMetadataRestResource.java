...
public class ODMMetadataRestResource extends SpringController {
    ...
    @RequestMapping(value = "/xml/view/{studyOID}", method = RequestMethod.GET,
    ...
    @RequestMapping(value = "/json/view/{study}", method = RequestMethod.GET,
    ...
    public String getPrintCRFController(
    ...
    @RequestMapping(value = "/xml/view/{studyOID}/{studyEventDefinitionOId}/{formVersionOID}", method = RequestMethod.GET,
    ...
    @RequestMapping(value = "/json/view/{studyOid}/{studyEventDefinitionOId}/{formVersionOID}", method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE + ";charset=UTF-8")
    @ResponseBody
