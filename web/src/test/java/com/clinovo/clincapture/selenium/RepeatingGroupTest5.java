...
public class RepeatingGroupTest5 extends BaseTest {
	...
	private void testRepeatingGroup() throws Exception {
		...
		setInputValue(1, "input982", "16");
		setNewInputValue(2, "input981", "x");
		setNewInputValue(2, "input982", "1");
		setNewInputValue(3, "input981", "x");
		setNewInputValue(3, "input982", "1");
