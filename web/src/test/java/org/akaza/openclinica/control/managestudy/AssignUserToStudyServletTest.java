...
public class AssignUserToStudyServletTest {

	private MockHttpServletRequest request;
	private MockHttpServletResponse response;
	private AssignUserToStudyServlet servlet;
	...
	public void setUp() throws Exception {
		...
		servlet = Mockito.mock(AssignUserToStudyServlet.class);
	...
	public void testThatNonAdminUserCannotProceed() throws InsufficientPermissionException {
		currentUser.addUserType(UserType.USER);
