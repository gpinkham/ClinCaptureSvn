...
public class StudyAuditLogServletTest {

	private MockHttpServletRequest request;
	private MockHttpServletResponse response;
	private StudyAuditLogServlet servlet;
	...
	public void setUp() throws Exception {
		...
		servlet = Mockito.mock(StudyAuditLogServlet.class);
	...
	@Test
	public void testThatStudyDirectorUserCanProceed() throws InsufficientPermissionException {
		currentUser.addUserType(UserType.USER);
