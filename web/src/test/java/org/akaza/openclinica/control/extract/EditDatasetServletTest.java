...
public class EditDatasetServletTest {

	private MockHttpServletRequest request;
	private MockHttpServletResponse response;
	private EditDatasetServlet servlet;
	...
	public void setUp() throws Exception {
		...
		servlet = Mockito.mock(EditDatasetServlet.class);
		...
		otherStudy.setId(12);
		sdao = Mockito.mock(StudyDAO.class);
		...
		dataset.setId(1);
		Mockito.when(servlet.initializeAttributes(request, 0)).thenReturn(dataset);
	}
