...
public class ScoreItemValidatorTest {

	private FormDiscrepancyNotes notes;

	private MockHttpServletRequest request;

	private ScoreItemValidator validator;
	...
	public void setUp() {
		...
		validator = new ScoreItemValidator(new ValidatorHelper(request, Mockito.mock(ConfigurationDao.class)), notes);
	}
