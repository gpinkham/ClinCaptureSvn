...
import com.clinovo.validator.EmailValidator;
...
public abstract class BaseService {
	...
	/**
	 * Method that checks role consistency.
	 *
	 * @param roleId
	 *            int
	 * @param studyBean
	 ...
	 *             the RestException
	 */
	public void checkRoleConsistency(int roleId, StudyBean studyBean) throws RestException {
		Role role = null;
		try {
		...
		if (role == null) {
			...
			throw new RestException(messageSource, "rest.createUser.studyDoesNotExist", new Object[]{studyBean.getId()},
					HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
		} else
	...
	/**
	 * Method that checks that username has not been taken.
	 * 
	 * @param userName
	 *            String
	 * @throws RestException
	 *             the RestException
	 */
	public void checkThatUsernameHasNotBeenTaken(String userName) throws RestException {
	 ...
	 *             the RestException
	 */
	public void validateEmail(String email) throws RestException {
		if (!EmailValidator.validate(email)) {
			throw new RestException(messageSource, "rest.createUser.emailIsNotValid",
					HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
		}
	}
}
